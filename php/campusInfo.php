...
<html lang="nb">
    ...
    <body> 
        ...
        <div class = "campusPhoto sectOne">
            <div id = "campusButtonContainer">
                <div id = "Fjerdingen" class="campusButton">Fjerdingen</div>
                <div id = "Vulkan" class="campusButton">Vulkan</div>
                <div id = "Brenneriveien" class="campusButton">Brenneriveien</div>
            </div>
        ...
        <script>
            ...
            */
            ...
            $("#Vulkan").click(function() {
                var top = $('.campusTextVulkan').offset().top
                top -= 0;
                $("html, body").animate({
                    scrollTop: top
                }, 1000);
            ...
            $("#Brenneriveien").click(function() {
                var top = $('.campusTextBrenneriveien').offset().top
                top -= 0;
                $("html, body").animate({
                    scrollTop: top
                }, 1250);
